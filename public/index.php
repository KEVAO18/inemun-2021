  	...
  	<nav class="mb-1 navbar navbar-expand-lg navbar-light bg-main fixed-top scrolling-navbar">
  	  ...
  	  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
  	    <ul class="navbar-nav mr-auto">
  	      ...
  	      <li class="nav-item">
  	        <a class="nav-link" href="<?=$serve?>/filosofia_y_metodos">Filosofia y Metodos</a>
  	      </li>
  	      <li class="nav-item">
  	      ...
  	      <li class="nav-item">
  	        <a class="nav-link" href="<?=$serve?>/contactanos">Contactanos</a>
  	      </li>
  	      <li class="nav-item">
  	        <a class="nav-link" href="<?=$serve?>/manual_del_delegado">Manual del delegado</a>
  	      </li>
  	      <li class="nav-item">
  	        <a class="nav-link" href="<?=$serve?>/portafolio">Portafolio</a>
  	      </li>
  	    </ul>
  	  ...
  	  <div class="container text-center text-md-left">
  	    <div class="row">
  	      ...
  	      <div class="col-md-3 mb-md-0 mb-3">
              ...
              <li>
                <a href="<?=$serve?>/manual_del_delegado" class="color-3">Manual del Delegado</a>
              </li>
              <li>
                <a href="<?=$serve?>/portafolio" class="color-3">Portafolio</a>
              </li>
  	        </ul>
  	      </div>
  	      <hr class="clearfix w-100 d-md-none pb-3">
  	      <div class="col-md-3 mb-md-0 mb-3">
  	        ...
  	        <ul class="list-unstyled list1">
  	          <li>
  	            <a href="<?=$serve?>/filosofia_y_metodos" class="color-3">Filosofia y Metodos</a>
  	          </li>
              <li>
                <a href="<?=$serve?>/junta_directiva" class="color-3">Junta directiva</a>
              </li>
              <li>
                <a href="<?=$serve?>/contactanos" class="color-3">Contactanos</a>
              </li>
  	        </ul>
  	      </div>
  	    </div>
